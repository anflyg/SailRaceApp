...
function toCsvContent(race: Race): string {
  ...
  const rows = race.samples.map((sample) => [
    ...
    toCsvValue(sample.nativeCourseDegrees),
    toCsvValue(sample.positionCourseDegrees),
    toCsvValue(sample.fusedCourseDegrees),
  ...
  const trackPoints = race.samples
    ...
    .map((sample) => {
      ...
      const extensions = [
        ...
        formatExtensionValue('nativeCourseDegrees', sample.nativeCourseDegrees),
        formatExtensionValue('positionCourseDegrees', sample.positionCourseDegrees),
        formatExtensionValue('fusedCourseDegrees', sample.fusedCourseDegrees),
